...
const Footer = () => {
  ...
  return (
    <div className='md:mx-10'>
        ...
        <div>
            <hr />
            <p  className='py-4 text-sm text-center'>© {new Date().getFullYear()} DrERP. All rights reserved.</p>
        </div>
    </div>
  )
}
