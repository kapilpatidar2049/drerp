      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6">
          <p className="text-lg leading-relaxed">
            Welcome to <strong className="text-blue-600">Dr.ERP</strong>, your trusted platform for finding and booking appointments with the best doctors across multiple specialties. We believe that accessing quality healthcare should be fast, reliable, and stress-free.
          </p>
...
<div className="mt-20">
  ...
  <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 text-center">
    ...
    <p className="text-lg text-center text-gray-800 mt-16 max-w-3xl mx-auto">
        Thank you for choosing <strong className="text-blue-600">Dr.ERP</strong>. Together, let's make healthcare more accessible and efficient.
    </p>
  </div>
